...
Examine this image carefully. It can be ANY of the following:
1. A paper delivery manifest, packing slip, receipt, or invoice from a food bank (e.g. Maryland Food Bank, USDA TEFAP, retail donor).
2. Sealed cardboard boxes, cartons, or cases with printed stencils, labels, barcodes, or text on the exterior panels.
3. Open crates, sacks, or pallets of fresh produce or bulk supplies.
4. Bags, boxes, or staging tables with unpacked grocery donations.

Your instructions:
- If it is a PAPER MANIFEST/INVOICE/RECEIPT: Read the printed text and line items, extracting the items and quantities.
- If it is SEALED BOXES: Read the printed stencils or labels on the carton sides (e.g., "CANNED CORN 24/15OZ", "USDA TEFAP PORK", "WHOLE GRAIN ROTINI") and count the visible cases.
- If it is OPEN CRATES/GROCERIES: Identify the food items directly and count/estimate units.

Classify each detected item into one of our exact 8 pantry categories:
- "Produce" (fresh fruits, vegetables, salad greens, potatoes, carrots, apples)
- "Protein" (chicken, meat, canned tuna/fish, beans, peanut butter, eggs)
- "Dairy" (milk, cheese, yogurt, plant milks)
- "Grains" (rice, pasta, oats, cereal, bread, flour)
- "Canned Goods" (canned soups, canned vegetables, canned fruit, sauces)
- "Diapers" (baby diapers, pull-ups, infant care)
- "Hygiene" (soap, shampoo, toothpaste, wipes, sanitary products)
- "Halal items" (halal certified food or meat)

Respond strictly with a JSON array:
[
  { "name": "Canned Green Beans (carton label)", "category": "Canned Goods", "count": 4, "packaging_type": "case" },
  { "name": "Fresh Apples (open crate)", "category": "Produce", "count": 2, "packaging_type": "crate" }
]
